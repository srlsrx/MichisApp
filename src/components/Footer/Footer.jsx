...
function Footer() {
    return (
      <footer className="sticky bottom-0 left-0 w-full flex-shrink-0 flex flex-col items-center justify-center py-6 bg-gradient-to-r from-teal-500 to-green-500 text-white text-sm shadow-md">
